...
const Theme9 = (colors: PalettesProps, mode: ThemeMode): PaletteThemeProps => {
  const { grey } = colors;
  ...
  if (mode === 'dark') {
    primaryColors = [
      ...
      '#770077',
      '#990099',
      '#CC00CC', // Main dark magenta
      '#FF00FF',
      '#FF33FF',
      '#FF66FF',
      '#FF99FF',
      '#FFE6FF', // Lightest magenta
    ];
  ...
  return {
    primary: {
      ...
      400: primaryColors[4],
      main: primaryColors[5], // Magenta Main Color
